module.exports = async () => {
  const Model = require('../models/places');
  ...
  function validatePayload() {
    return {
      ...
      country: Joi.string().min(20).required(),
      state: Joi.string().min(20).required(),
      city: Joi.string().min(20).required(),
      comments: Joi.string().min(20).required(),
      avaliation: Joi.string().min(20).required(),
